<?
	...
	class CheckMK extends IPSModule {
		...
		private function UpdateConfig()
		{
			...
			$url = 'http://' . $this->ReadPropertyString("User") . ':' . $this->ReadPropertyString("Password") . '@' . $this->ReadPropertyString("Server") . ':'  . $this->ReadPropertyString("Port") . '/' . $this->ReadPropertyString("Site") . '/' . $CMK_URL_ALLHOSTS . '&' . $CMK_URL_JSON;
